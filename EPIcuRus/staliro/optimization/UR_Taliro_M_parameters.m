...
% 
% ur_params = UR_Taliro_M_parameters
%
...
classdef UR_Taliro_M_parameters
    ...
    methods        
        function obj = UR_Taliro_M_parameters(varargin)
            if nargin>0
                error(' UR_Taliro_M_parameters : Please access directly the properties of the object.')
            end
        end
    end
end