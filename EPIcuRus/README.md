This folder contains necessary functions to run EPIcuRus which published by Gaaloul et al. in ``Mining assumptions for software components using machine learning".
