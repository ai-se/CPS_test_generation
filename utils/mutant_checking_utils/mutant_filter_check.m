% this function check the random generated test cases on manually generated
% mutants

function [mutation_testing_result, mutants_list] = mutant_filter_check(...
    selected_data,...
    M,...
    sim_opt,...
    opt,...
    ...
    if strcmp(M, 'Tiny')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/Tiny/Tiny_mutants', '*.slx'));
    ...
    elseif strcmp(M, 'Twotanks')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/Twotanks/Twotanks_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'EMB')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/EMB/EMB_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'CW')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/CW/CW_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'CC')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/CC/CC_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'clc_sldv')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/CLC/CLC_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'RHB2')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/RHB2/RHB2_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
    ...
    elseif strcmp(M, 'AFC')
        dinfo = dir(fullfile('E:/Research/CPS_testing/TestCaseGeneration/project/AFC/AFC_mutants', '*.slx'));
        file_name = {dinfo.name};
        mutants_list = {};
        for i = 1:size(file_name, 2)
            [p, f, ~] = fileparts(file_name{i});
